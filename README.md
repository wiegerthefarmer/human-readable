...
- `characters/` — Recurring character notes and canonical references
- `style/` — Visual style, layout rules, and recurring motifs
...
The series should focus on the human side of technical systems:
